...
public class SpearmanPatrolState : BaseState<SpearmanBrain>
{
    ...
    public override void UpdateState()
    {
        ...
        if (Physics2D.Raycast(brain.raycastTransform.position, Vector2.down, 2f, brain.WhatIsGround) && !Physics2D.Raycast(brain.raycastTransform.position, brain.raycastTransform.right, 4.5f, brain.WhatIsGround))
        {
